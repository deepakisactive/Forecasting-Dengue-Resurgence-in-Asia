# Project Title :  Forecasting Dengue Resurgence in Asia
A Cross-Regional Comparison of Machine Learning and Compartmental Models Across Thailand, Sri Lanka, and Bangladesh
...
### The Problem:
Both models can look accurate when tested on past data. But they can give completely opposite predictions about the future — especially after an unusually quiet year.

A policymaker looking at the ML model might think everything is fine and do nothing. The mechanistic model might be screaming that a big outbreak is coming. Who should they listen to?
...
| What | Where | How |
|------|------|-----|
| Dengue cases | OpenDengue | Load directly in Python via URL — no download needed |
| Population | World Bank | Download CSV from their website |
| Country maps | GeoPandas built-in | One line of code — no download needed |